...
# Parse args
parse_arg="$1"
NTS_ROOTPATH_210=/home/ntb-server1/rui/NTSock/
NTS_ROOTPATH_211=/home/ntb-server2/rui/NTSock/
s_metric="$2"
s_payload_size="$3"
s_n="$4"
s_thread="$5"
s_partition="$6"
s_packet_size="$7"
NTS_file_path=./NTSocks_data/mb4096/
...
payload_size_arr=(8 16 32 64 128 256 512 1024 2032 4064 8128)
